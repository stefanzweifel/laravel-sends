...
class TestMailWithRelatedModelsHeaderPassAsArgumentsNewSyntax extends Mailable
{
    use Queueable;
    ...
    public function headers()
    {
        return new Headers(
            ...
            ], $this->getAssociateWithHeader([$this->testModel, $this->anotherTestModel])->toArray()),
        );
    }
}
